...
% Moss et al 2021 procedure for Maximum Displacement
...
for m = 1 : 1 : 251 %this gives the mag bins from 5-7
    ...
    for r = 1 : 1 : 51 %this gives the x/L bins from 0 to 0.5 with 
        ...
        %Coppersmith regression) 0.31 * 2.302 is the standard deviation
        %term in ln space
        
        %B is the Prob(D/MD|M,r) from statistical fitting of gamma or
        %weibull distributions

        A = trlnrnd(mu((5+(2/250) * (m - 1))) , 0.31*2.302, 5000);
